...
Dieser Schritt kostet bei jedem Build einen vollständigen Self-contained-Publish. Für schnelle Zwischenbuilds lässt er sich mit `-p:SkipRootExecutablePublish=true` überspringen; der Prüflauf nutzt den Schalter für Build und Tests und lässt den Publish genau einmal laufen, am Ende, für die Dateien, die danach ins Release gehen.

...
Geprüfte Version: Arbeitsstand nach **2026.0831.01**; die Korrekturen am Beenden-Ablauf sind noch nicht als Release veröffentlicht.

## Bestanden

- Release-Build für Windows 11 x64: 0 Fehler, 0 Warnungen (`TreatWarningsAsErrors` in allen Projekten aktiv).
- 336 automatisierte Tests: 336 bestanden, 0 fehlgeschlagen, 0 übersprungen.
- Selbständiger `win-x64`-Einzeldatei-Publish: 71'896'643 Bytes, unter dem Limit von 100'000'000 Bytes.
...
- **Das Beenden wurde nicht am laufenden Programm nachgestellt.** Die drei behobenen Ursachen sind durch Tests abgedeckt, ein manueller Durchlauf «Rechtsklick im Infobereich → Beenden» steht aus.

...
$defaultDestination = [System.IO.Path]::GetFullPath((Join-Path $projectRoot 'SaschaWindowZones.exe'))
...
if ([System.IO.Path]::GetFileName($destinationPath) -ne 'SaschaWindowZones.exe') {

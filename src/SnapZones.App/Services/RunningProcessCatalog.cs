...
public sealed record RunningProcessEntry(string DisplayName, string ProcessPath, string WindowTitle)
{
    ...
    /// <c>…\Discord\app-1.0.9016\Discord.exe</c>. Eine Regel auf diesen Pfad hört beim nächsten
    /// Update auf zu greifen, während <c>Discord.exe</c> unabhängig vom Installationsort trifft.
    /// </summary>

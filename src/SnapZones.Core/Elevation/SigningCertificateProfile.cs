...
public static class SigningCertificateProfile
{
    ...
    public const string Subject = "CN=Sascha's Zone Manager Fensterhelfer";

    public const string FriendlyName = "Sascha's Zone Manager – Fensterhelfer";
    ...
    public static string BuildRemoveScript() =>
        ...
        foreach ($store in 'My','Root','TrustedPublisher') {
            ...
            foreach ($candidate in @($target.Certificates)) {
                if ($candidate.Subject -eq '{{Escape(Subject)}}') {

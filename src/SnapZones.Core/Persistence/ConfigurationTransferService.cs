...
public sealed class ConfigurationTransferService
{
    ...
    private const string ProductName = "Sascha Window Zones";
    ...
    public async Task<SnapConfiguration> ImportAsync(string filePath, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (archive.ArchiveVersion != CurrentArchiveVersion ||
            ...
            JsonConfigurationRepository.Validate(archive.Configuration);

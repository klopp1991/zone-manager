...
public sealed class ConfigurationTransferService
{
    ...
    private const string ProductName = "Sascha’s Zone Manager";
    private const string LegacyProductName = "Sascha Window Zones";
    ...
    public async Task<SnapConfiguration> ImportAsync(string filePath, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var supportedProduct =
                ...
                string.Equals(archive.Product, LegacyProductName, StringComparison.Ordinal);

...
public sealed class SigningCertificateService
{
    ...
    public bool IsSigned(string filePath)
    {
        ...
        try
        {
            ...
            return string.Equals(certificate.Subject, SigningCertificateProfile.Subject, StringComparison.Ordinal);
        }
        catch (Exception)
        {
    ...
    private static X509Certificate2? FindIn(string storeName)
    {
        ...
        return store.Certificates
            .FirstOrDefault(candidate =>
                string.Equals(candidate.Subject, SigningCertificateProfile.Subject, StringComparison.Ordinal));
    }
